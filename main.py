...
def sync_ocr(content: bytes) -> str:
    ...
    # Strip unprintable, non-ASCII, and weird formatting characters that trigger Llama 3.2 safety filters
...
async def chat_endpoint(req: ChatRequest):
    ...
    system_prompt = f"""You are Omnisense, an intelligent and helpful AI assistant. You answer questions based ONLY on the provided MEMORY context.
...
5. The MEMORY text is generated by raw OCR and may contain random typos or disjointed phrases. Ignore any corrupted formatting and focus on the readable English words. Do not refuse to answer based on formatting.
